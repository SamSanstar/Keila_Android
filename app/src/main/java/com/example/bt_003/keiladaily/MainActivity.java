...
public class MainActivity extends AppCompatActivity
    ...
    ArrayList<ModelNewFeed> lstNewFeed;
...
//        setSupportActionBar(toolbar);
        ...
        lstNewFeed = ModelNewFeed.generateNewFeed(20);

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rv_new_list);
        NewFeedAdapter adapter = new NewFeedAdapter(this, lstNewFeed);
